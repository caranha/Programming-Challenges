...
\begin{frame}
  ...
  \item All programs must begin in a static main method in a \structure{Main} class.
...
\begin{frame}
  ...
  Evaluation Criteria: \structure{Problems solved}, \structure{Code} and \structure{Participation}
...
\begin{frame}
  ...
  The \structure{Base Grade} is decided solely based on UVA
  submissions. 
...
\begin{frame}
  ...
  The assignments are \alert{individual}. Use your \structure{own strength} to solve the programs.
...
\begin{frame}
  ...
  \begin{itemize}
  \item \structure{New Book:} Competitive Programming, 3rd Edition\\
    \url{http://cpbook.net/}\\
    
    \bigskip

  \item \structure{Old Book:} Programming Challenges\\
