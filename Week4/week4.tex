...
\begin{frame}
  ...
  {\smaller
    \begin{block}{Problem Summary}
      We define that vertex $X$ \structure{dominates} vertex $Y$ if
...
\end{verbatim}
    ...
    \begin{itemize}
    \item \structure{Pro}: Very simple to program and use;
    \item \alert{Con}:
      \begin{itemize}
...
This is a very unusual structure! It is used by \structure{Kruskal's
  Algorithm}
