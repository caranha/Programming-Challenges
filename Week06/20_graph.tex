...
\begin{frame}
  \frametitle{Dijkstra's Algorithm for weighted SSSP}
...
\begin{frame}[fragile]
  \frametitle{Dijkstra's Algorithm: One Implementation Example}
  {\smaller
    \begin{exampleblock}{}
\begin{verbatim}
...
\begin{frame}
  \frametitle{Dijkstra's implementation trick: Lazy deletion}
  {\smaller
    \begin{itemize}
    \item Dijkstra Requires us to store the edge to vertex $v$ with
  ...
  % TODO: Redraw Dijkstra graph by hand
  \begin{center}
...
\begin{frame}
  ...
  {\smaller
    ...
    \begin{block}{}
      Using Dijkstra directly is hard -- how do we model buying gas
